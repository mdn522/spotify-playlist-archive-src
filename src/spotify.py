...
class Spotify:
    ...
    def __init__(
        ...
        self._client_refresh_token: str = client_refresh_token
        ...
        while True:
            ...
            if not self._access_token:
                ...
                self._access_token = await self.get_access_token(
                    ...
                    client_refresh_token=self._client_refresh_token,
                )
    ...
    @classmethod
    async def get_access_token(cls, client_id: str, client_secret: str, client_refresh_token: str = None) -> str:
        if not client_id:
